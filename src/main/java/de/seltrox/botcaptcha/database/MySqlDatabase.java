...
public class MySqlDatabase extends Database {
    ...
    public void connect() {
        ...
        try {
            this.connection = DriverManager.getConnection("jdbc:mysql://" + this.configuration.getString("database.mySql.host") + ":3306/"
                            + this.configuration.getString("database.mySql.database") + "?autoReconnect=true",
                    this.configuration.getString("database.mySql.username"),
                    this.configuration.getString("database.mySql.password"));
